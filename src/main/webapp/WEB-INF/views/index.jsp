...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top"
		id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="#page-top">Mkki Board</a>
		...
		<div class="container-fluid">
			<div class="row no-gutter popup-gallery">
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="/resources/bootstrap/img/portfolio/fullsize/1.jpg"> <img
						class="img-fluid" src="/resources/bootstrap/img/portfolio/thumbnails/1.jpg" alt="">
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="/resources/bootstrap/img/portfolio/fullsize/2.jpg"> <img
						class="img-fluid" src="/resources/bootstrap/img/portfolio/thumbnails/2.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="/resources/bootstrap/img/portfolio/fullsize/3.jpg"> <img
						class="img-fluid" src="/resources/bootstrap/img/portfolio/thumbnails/3.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="/resources/bootstrap/img/portfolio/fullsize/4.jpg"> <img
						class="img-fluid" src="/resources/bootstrap/img/portfolio/thumbnails/4.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="/resources/bootstrap/img/portfolio/fullsize/5.jpg"> <img
						class="img-fluid" src="/resources/bootstrap/img/portfolio/thumbnails/5.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
				...
				<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="/resources/bootstrap/img/portfolio/fullsize/6.jpg"> <img
						class="img-fluid" src="/resources/bootstrap/img/portfolio/thumbnails/6.jpg" alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Category</div>
								<div class="project-name">Project Name</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 mx-auto text-center">
					...
					<hr class="primary">
					<p> If you've any question, Give
						me a call or send us an email and I will get back to you as soon
						as possible!</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 mr-auto text-center">
					...
					<p>
						<a href="mailto:your-email@your-domain.com">mkkiworldfeed@gmail.com</a>
					</p>
				</div>
			</div>
		</div>
